<?php if (!defined('THINK_PATH')) exit(); header('Content-type:text/html;charset=utf8'); $navs = D("Menu")->getBarNav(); ?>
...
<head>
  ...
  <link rel="stylesheet" href="/PHP/Public/css/bootstrap.min.css" type="text/css" />
  <link rel="stylesheet" href="/PHP/Public/css/home/main.css" type="text/css" />
</head>
<body>
<header id="header">
  <div class="navbar-inverse">
    <div class="container">
      <div class="navbar-header">
        <a href="./">
          <img src="/PHP/Public/images/logo.png" alt="">
        </a>
      </div>
      <ul class="nav navbar-nav navbar-left">
        ...
        <?php if(is_array($navs)): foreach($navs as $key=>$vo): ?><li><a href="./index.php?c=cat&id=<?php echo ($vo["menu_id"]); ?>"
            <?php if($vo['menu_id'] == $result['catId']): ?>class="curr"<?php endif; ?>><?php echo ($vo["name"]); ?></a>
      ...
      <div class="col-sm-9 col-md-9">
        <div class="banner">
          <div class="banner-left">
            <div class="banner-info"><span>阅读数</span><i class="news_count node-<?php echo ($result['topPic'][0]['news_id']); ?>" news-id="<?php echo ($result['topPic'][0]['news_id']); ?>" id="node-<?php echo ($result['topPic'][0]['news_id']); ?>"></i></div>
            <a target="_blank" href="./index.php?c=detail&id=<?php echo ($result['topPic'][0]['news_id']); ?>"><img width="670" height="360" src="<?php echo ($result['topPic'][0]['thumb']); ?>" alt=""></a>
          </div>
          <div class="banner-right">
            <ul>
              <?php if(is_array($result['threePic'])): $i = 0; $__LIST__ = $result['threePic'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
...
<script src="/PHP/Public/js/count.js"></script>
</html>